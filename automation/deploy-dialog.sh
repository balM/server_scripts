...
declare -r DRUPAL_RELEASE="/home/andy/cores/drupal/release"
...
#       display first the informations related to te Drupal core.
#       Who did the last commit? When? What is the SHA1 hash of that commit?
#       We have all this informations in the 'relese' file located within the core
#       The 'release' file is generated by us when we upload a new CORE.
dialog --title "Drupal CORE details..." \
--backtitle "$BACKTITLE" \
--yesno "$(cat $DRUPAL_RELEASE)" 15 50
